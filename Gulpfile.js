...
var gemsnoteBase = './';
var base = gemsnoteBase + '/public'; // public base
var noteDev = gemsnoteBase + '/app/views/note/note-dev.html';
var noteProBase = gemsnoteBase + '/app/views/note';

var messagesPath = gemsnoteBase + 'messages';
...
gulp.task('i18n', function() {
    ...
    function genI18nJsFile(targetFilename, lang, fromFilenames, keys) {
        ...
        fromFilenames.forEach(function (name) {
            var tmpMsgs = getAllMsgs(gemsnoteBase + '/messages/' + lang + '/' + name + '.conf');
    ...
    function genTinymceLang(lang) {
        var msgs = getAllMsgs(gemsnoteBase + 'messages/' + lang + '/tinymce_editor.conf');
...
var tinymceBase = '/Users/life/gemsnote/gemsnote-tools/tinymce_4.1.9_gemsnote_public';
gulp.task('tinymce', function() {
    ...
    var bundleCmd = 'grunt bundle --themes gemsnote --plugins autolink,link,leaui_image,leaui_mindmap,lists,hr,paste,searchreplace,gemsnote_nav,gemsnote_code,tabfocus,table,directionality,textcolor';
    // build
